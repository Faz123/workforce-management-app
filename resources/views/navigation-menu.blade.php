<nav x-data="{ open: false }" class="bg-gradient-to-r from-purple to-purple-lighter">
            ...
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('home') }}">
                        ...
                        <h2 class="text-white text-4xl">Dice</h2>
                    </a>
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-jet-responsive-nav-link href="{{ route('holiday') }}" :active="request()->routeIs('holiday')">
                {{ __('Holiday') }}
            </x-jet-responsive-nav-link>
        </div>
